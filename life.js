...
var _user$project$Main$toInt = function (bool) {
	var _p0 = bool;
	if (_p0 === true) {
		return 1;
	} else {
...
var _user$project$Main$row = function (len) {
	return A2(_elm_lang$core$Array$repeat, len, false);
};
var _user$project$Main$resize = F3(
	function ($default, newLen, oldArray) {
		var len = _elm_lang$core$Array$length(oldArray);
		return (_elm_lang$core$Native_Utils.cmp(newLen, len) > 0) ? A2(
			_elm_lang$core$Array$append,
			oldArray,
			A2(_elm_lang$core$Array$repeat, newLen - len, $default)) : A3(_elm_lang$core$Array$slice, 0, newLen, oldArray);
	});
var _user$project$Main$height = function (board) {
	return _elm_lang$core$Array$length(board);
};
var _user$project$Main$width = function (board) {
	return A2(
...
var _user$project$Main$get = F3(
	function (y, x, board) {
		var y = A2(
			_elm_lang$core$Basics_ops['%'],
			y,
			_user$project$Main$height(board));
		var x = A2(
			_elm_lang$core$Basics_ops['%'],
			x,
			_user$project$Main$width(board));
		return A2(
			_elm_lang$core$Maybe$withDefault,
			false,
			A2(
				_elm_lang$core$Maybe$andThen,
				A2(_elm_lang$core$Array$get, y, board),
				_elm_lang$core$Array$get(x)));
	});
var _user$project$Main$updateTile = F4(
	function (board, y, x, tile) {
		var count = A3(
			_elm_lang$core$List$foldl,
			F2(
				function (_p1, total) {
					var _p2 = _p1;
					return total + _user$project$Main$toInt(
						A3(_user$project$Main$get, _p2._0, _p2._1, board));
				}),
			0,
			_elm_lang$core$Native_List.fromArray(
				[
...
var _user$project$Main$updateRow = F3(
	function (board, y, row) {
		return A2(
			_elm_lang$core$Array$indexedMap,
			A2(_user$project$Main$updateTile, board, y),
			row);
	});
var _user$project$Main$set = F4(
	function (y, x, val, board) {
		var y = A2(
			_elm_lang$core$Basics_ops['%'],
			y,
			_user$project$Main$height(board));
...
var _user$project$Main$tileSize = 50;
		...
		return {
			...
			_0: function () {
				...
				switch (_p4.ctor) {
					case 'Resize':
						var _p5 = _p4._0;
						var height = (_p5.height / _user$project$Main$tileSize) | 0;
						var width = (_p5.width / _user$project$Main$tileSize) | 0;
						return A2(
							_elm_lang$core$Array$map,
							A2(_user$project$Main$resize, false, width),
							A3(
								_user$project$Main$resize,
								_user$project$Main$row(width),
								height,
								board));
					case 'Click':
						var _p7 = _p4._0._0;
						...
						return A4(
							...
							_elm_lang$core$Basics$not(
								A3(_user$project$Main$get, _p6, _p7, board)),
							board);
					default:
						return A2(
							_elm_lang$core$Array$indexedMap,
							_user$project$Main$updateRow(board),
							board);
				}
			}(),
...
var _user$project$Main$init = {
	ctor: '_Tuple2',
	_0: _elm_lang$core$Array$empty,
	_1: A3(
		_elm_lang$core$Task$perform,
		function (_p8) {
			return _user$project$Main$Resize(
				{height: 0, width: 0});
		},
		_user$project$Main$Resize,
		_elm_lang$window$Window$size)
};
var _user$project$Main$sizeToMsg = function (x) {
...
var _user$project$Main$viewTile = F3(
	function (y, x, tile) {
		return A2(
	...
	function (y, row) {
		return A2(
			...
			_elm_lang$core$Array$toList(
				A2(
					_elm_lang$core$Array$indexedMap,
					_user$project$Main$viewTile(y),
					row)));
	});
var _user$project$Main$view = function (board) {
	return A2(
		_elm_lang$html$Html$table,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Array$toList(
			A2(_elm_lang$core$Array$indexedMap, _user$project$Main$viewRow, board)));
};
